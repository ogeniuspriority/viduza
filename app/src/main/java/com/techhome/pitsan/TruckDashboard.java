...
public class TruckDashboard extends AppCompatActivity {
    ...
    public static volatile int window_number = 0;
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_truck_dashboard, menu);
        return true;
    }
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                case 0:
                    ...
                    return CrowdsourcingFragment.newInstance(date, location, volume);
                case 1:

                    return SingleFragment.newInstance(date, location, volume);
                case 2:
