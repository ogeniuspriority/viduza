 ...
 */
public class pitsan_parse_crowdsourcing_feed_pit_data extends AsyncTask<Void, Void, Boolean> {
    Context c;
    String jsonData;
    ...
    public pitsan_parse_crowdsourcing_feed_pit_data(Context c, String jsonData, ListView singleList) {
        this.c = c;
    ...
    protected void onPostExecute(Boolean isParsed) {
        ...
        if (isParsed) {
            ...
            singleList.setAdapter(new custom_adapter_for_pitsan_crowdsourcing_pit(c, pitsan_single_pit_full_names,
