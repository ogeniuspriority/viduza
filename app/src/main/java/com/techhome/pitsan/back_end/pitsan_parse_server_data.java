 ...
 */
public class pitsan_parse_server_data extends AsyncTask<Void, Void, Boolean> {
    Context c;
    String jsonData;
    ...
    public pitsan_parse_server_data(Context c, String jsonData, ListView boolax_boos_list) {
        this.c = c;
