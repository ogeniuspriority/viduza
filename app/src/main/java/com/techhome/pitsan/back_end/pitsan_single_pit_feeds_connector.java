 ...
 */
public class pitsan_single_pit_feeds_connector {
    public static HttpURLConnection connect(String magicUrl, String trucker_id) {
        ...
        try {
            ...
            //--con properties-
            String data = "";
            data = URLEncoder.encode("trucker_id", "UTF-8")
                    + "=" + URLEncoder.encode(trucker_id, "UTF-8");
